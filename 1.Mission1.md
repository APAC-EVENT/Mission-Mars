...
참고로, 여기서 생성된 X1과 X2는 아까 전 **||**으로 split한 두 String입니다. 실제 data를 보면 첫째 String은 의미가 없고, 둘째 String만 의미가 있는 문장임을 알 수 있습니다. 하지만 방금 R 코드에서는 두 String의 각자의 이름을 붙여주지 않았기 때문에, 임의로 X1, X2라는 이름이 붙었습니다.
